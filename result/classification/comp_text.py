...
if __name__ == '__main__':
    json_file = json.load(open('/storage_fast/ccye/zmyang/20240408/text_comp.json', 'r'))
    ...
    prompt = get_prompt()
    print('complementary_text_result')
    print("**************************")
    print('Prompt:')
    print(prompt)
    cnt = 0
    ...
    json.dump(judge, open('comp_text_result.json', 'w'))
